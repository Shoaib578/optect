...
class EditOperator extends React.Component{
    ...
    render(){
        return(
            ...
            <TouchableOpacity disabled={this.state.isLoading} onPress={this.UpdateOperator} style={styles.LoginButton}>
                {this.state.isLoading?<ActivityIndicator size="small" color=    "black"/>:null}
                    <Text style={styles.LoginButtonText}>{this.state.lang.update_operator}</Text>
            </TouchableOpacity>
                </View>
            </SafeAreaView>
            </ScrollView>
