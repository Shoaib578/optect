...
class AllOrders extends React.Component{
    ...
    translate = async()=>{
     ...
     getMyorders = async()=>{
        ...
        console.log("My id"+parse.id)
         firestore().collection('orders').where("supervisor_id","==",parse.id).get()
         .then(res=>{
    ...
    render(){
      ...
      return  <Text style={{color:"red",textAlign:"center",marginTop:30,fontWeight:"bold"}}>{this.state.lang.dont_have_any}</Text>
    }
